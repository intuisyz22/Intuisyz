  ...
  <?php include("../non_free_q.php"); ?>
        ...
        <div class="conts" style="background:#fff ; color:#000;">
          <div class="container">
                ...
                <div class="row" > <!--row being-->
                	<div class="col-md-12">
                    	 <a href="priceing_website.php"><div class="col-md-31 subhead">
                        Web designing
                        </div></a>
                      ...
                      <a href="priceing_e_commerce.php">   <div class="col-md-31 subhead">	
                       ...
                       <a href="priceing_erp_retails.php">  <div class="col-md-31 subheadactv">
                        	  ERP - Retail
                        </div></a>
    ...
    <table class="table table-condensed">
      ...
      <tbody>
        <tr class="tfstrornge" style="padding:10px 0px;">
          ...
          <td class="tlornge mayhe tblfont"  style="color:#398026; ">2,00,000</td>
        ...
        <tr>
          <th >Front Desk Module</th><td class="trone"  align="center"><img src="../n_images/cross.png" alt="Not Included"></td><td align="center"><img src="../n_images/cross.png" alt="Not Included"></td><td class="trone" align="center"><img src="../n_images/ok.png" alt="Included"></td>
        </tr>
        <tr>
        ...
        <tr>
          <th >Customer Relationship Mgmt</th><td class="trone"  align="center"><img src="../n_images/cross.png" alt="Not Included"></td>
