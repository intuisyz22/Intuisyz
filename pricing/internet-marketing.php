 ...
 <!--header end--> 	
    ...
    <table class="table table-condensed">
      ...
      <tbody>
          ...
          <td class="tlornge" style="color:#398026; font-size:20px; padding:15px 0px;">25,000/Month</td>
          <td style="color:#398026; font-size:20px; padding:15px 0px;">1,00,000/Month</td>
           <!-- <td style="color:#398026; font-size:20px; padding:15px 0px;"></td> -->
          
          <td class="tlornge" style="color:#398026; font-size:20px; padding:15px 0px;">5,00,000/Month</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Google Plus Company Page </td>
                                            <td class="trone"><img src="../n_images/ok.png" alt="Included" title="Checked"></td>
                                            <td><img src="../n_images/ok.png" alt="Included" title="Checked"></td>
                                            <!-- <td><img src="../n_images/ok.png" alt="Included" title="Checked"></td> -->
                                            <td class="trone"><img src="../n_images/ok.png" alt="Included" title="Checked"></td>
                                        ...
                                        <tr>
                                            <td>In Page Optimization </td>
                                            <td  class="trone"><img src="../n_images/ok.png" alt="Not Included" title="Unchecked"></td>
                                            <td><img src="../n_images/ok.png" alt="Included" title="Checked"></td>
                                            <!-- <td><img src="../n_images/ok.png" alt="Included" title="Checked"></td> -->
                                            <td  class="trone"><img src="../n_images/ok.png" alt="Included" title="Checked"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th><B>Advanced Digital Marketing </B></th>
                                            <td> </td>
                                            <td> </td>
                                            <!-- <td class="trone">&nbsp;</td> -->
                                            <td> </td>
                                        ...
                                        <tr>
                                            <td> Enquiry Improvement Guarantee  </td>
                                            <td><img src="../n_images/cross.png" alt="Not Included" title="Unchecked"></td>
                                            <td><img src="../n_images/cross.png" alt="Not Included" title="Unchecked"></td>
                                            <!-- <td class="trone">2</td> -->
                                            <td><img src="../n_images/ok.png" alt="Included" title="Checked"></td>
