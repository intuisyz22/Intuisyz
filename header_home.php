...
#top-bar .navbar-nav > li > .soc-li:hover {
  background: rgba(98, 100, 245, 1);
}
	...
	<!--technology outsource -->
          ...
          <li><a href="<?php echo $baseurl;?>blog.php">BLOG</a></li> 
                ...
                <ul class="nav navbar-nav visible-lgg" style="float:right;">
                        <li>
                        <a href="https://wa.me/+918592902277" style="text-decoration:none;background-color:transparent !important" class="soc-li" target="_blank"  >
