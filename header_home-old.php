...
<header id="top-bar" class="navbar-fixed-top animated-header">
    <nav class="social">
        <div class=" contain">
            ...
            <a href="https://intuisyz.com/blog/" target="_blank"  class="socio" style="color: #fff;">Blog</a>
            <a href="about-us/career.php" style="color: #fff;" class="socio">Career</a>
    ...
    <div class="contain">
                ...
                <span class="navbar-brand" style="float: left !important;">
                    <a href="https://intuisyz.com/">
                    <img src="https://intuisyz.com/img/logo-black.png" title="Web design in Kochi" alt="Web design in Kochi">
                    </a>
                </span>
                        ...
                        <ul class="dropdown-menu multi-column columns-3 wido ">
                            <div class="row b-gray-2">
                                <div class="col-sm-6 menu-bg-1 pdm">
                                    <h4 ><a href="https://intuisyz.com/digital-marketing.php"><!-- Branding Design -->Digital Marketing</a> </h4>
                                    ...
                                    <ul class="multi-column-dropdown ">
                                        ...
                                        <li><a href="https://intuisyz.com/digital-marketing/internet-marketing/measurement.php">Measurement</a></li>
                                        <li><a href="https://intuisyz.com/digital-marketing/internet-marketing/enhancement.php">Enhancement</a></li>

                                        <h4 >Platforms</h4>
                                        <hr style=" border-top: none !important; background: palevioletred !important;">
                                        <ul class="multi-column-dropdown ">
                                            <li><a href="https://intuisyz.com/seo/seo.php">Search Engine Optimization</a></li>
                                ...
                                <div class="col-sm-6 menu-bg-3 black-c">
                                    ...
                                    <div >
                                        <sup>At</sup> <span style="color: #000 !important; font-size: 34px; font-weight: bold;">25</span> K / Month onwards
                                    </div>
                    ...
                    <li class="">
                        ...
                        <ul class="dropdown-menu multi-column columns-2 wid-6 ">
                            <div class="row b-gry" style="padding: 5px 5px 5px 5px">
                                <div class="col-sm-6 text-uppercase b-gry pdngs">
                                ...
                                <div class="col-sm-6 black-c b-gry pdngs">
                                    <div class="p-b-20">
...
<style>
    ...
    nav{display:block;width:100%;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:14px !important;
