...
(function (E, X) {
    ...
    var A, y = E.document, W = Math, B = W.round, S = W.floor, ua = W.ceil, t = W.max, F = W.min, P = W.abs, U = W.cos, $ = W.sin, ra = W.PI, fa = ra * 2 / 360, za = E.navigator && E.navigator.userAgent || "", Lb = E.opera, ya = /(msie|trident|edge)/i.test(za) && !Lb, lb = y && y.documentMode === 8, mb = !ya && /AppleWebKit/.test(za), Na = /Firefox/.test(za), Mb = /(Mobile|Android|Windows Phone)/.test(za), Fa = "http://www.w3.org/2000/svg", ca = y && y.createElementNS && !!y.createElementNS(Fa,
            "svg").createSVGRect, Qb = Na && parseInt(za.split("Firefox/")[1], 10) < 4, ga = y && !ca && !ya && !!y.createElement("canvas").getContext, cb, db, Nb = {}, zb = 0, jb, N, Qa, G, Aa = function () {
    }, T = [], eb = 0, Ma = "div", Rb = /^[0-9]+$/, nb = ["plotTop", "marginRight", "marginBottom", "plotLeft"], qa, kb, qb, Za, tb, ub, vb, $a, ab, bb, Gb, Hb, Ib, Jb, wb, xb, yb, I = {}, z;
    z = E.Highcharts ? X(16, !0) : {win: E};
    z.seriesTypes = I;
    var Ga = [], ja, sa, o, Ha, Ab, Ba, M, V, H, Wa, Oa;
    pb.prototype = {
        dSetter: function () {
    ...
    Qa = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"),
            d = new qa(b - Ya(b)), e, f = d[ub](), g = d[vb](), h = d[$a](), i = d[ab](), k = d[bb](), j = N.lang, m = j.weekdays, d = u({
                a: m[g].substr(0, 3),
                A: m[g],
                d: Ka(h),
                e: h,
    ...
    N = {
        ...
        lang: {
            ...
            resetZoomTitle: "Reset zoom level 1:10",
            thousandsSep: " "
        },
        global: {
            useUTC: !0,
        ...
        title: {text: "Chart title", align: "center", margin: -2, style: {color: "#333333", fontSize: "12px"}},
        subtitle: {
            text: "",
    ...
    O.prototype = {
        ...
        colorGradient: function (a, b, c) {
            var d = this.renderer, e, f, g, h, i, k, j, m, l, n, r, s = [], p;
        ...
        applyTextShadow: function (a) {
            var b = this.element, c, d = a.indexOf("contrast") !== -1, e = {}, f = this.renderer.forExport, g = f || b.style.textShadow !== A && !ya;
        ...
        getBBox: function (a, b) {
            ...
            e = this.textStr;
            var k, j = h.style, m, l = d.cache, n = d.cacheKeys, r;
            f = p(b, this.rotation);
            g = f * fa;
    ...
    Ca.prototype = {
                ...
                o(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            K(s, n);
                            b.appendChild(s);
                            !l && f && (!ca && d && L(s, {display: "block"}), K(s, "dy", v(s)));
                            if (m) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), R = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, w, q, t = [], u = v(s), A = 1, B = a.rotation, z = e, D = z.length; (R || r) && (n.length || t.length);)a.rotation = 0, o = a.getBBox(!0), q = o.width, !ca && c.forExport && (q = c.measureSpanWidth(s.firstChild.data, a.styles)), o = q > m, w === void 0 && (w = o), r && w ?
        ...
        getContrast: function (a) {
            ...
            var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, m, l, n, r, s, p, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            var e = Y(a) ? a.r : e, g = this.createElement("rect"), a = Y(a) ? a : a === A ? {} : {
                x: a,
                y: b,
                width: t(c, 0),
                height: t(d, 0)
            ...
            var g = this, h, i = this.symbols[a], i = i && i(B(b), B(c), d, e, f), k = /^url\((.*?)\)$/, j, m;
            if (i)h = this.path(i), u(h, {
                symbolName: a, x: b, y: c, width: d,
                height: e
            }), f && u(h, f); else if (k.test(a))m = function (a, b) {
                a.element && (a.attr({
                    width: b[0],
                    height: b[1]
                ...
                x: b,
                y: c
            }), h.isImg = !0, a ? m(h, a) : (h.attr({width: 0, height: 0}), Z("img", {
                onload: function () {
            ...
            circle: function (a, b, c, d) {
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = U(f), k = $(f), j = U(g), g = $(g), e = e.end - f < ra ? 0 : 1;
            ...
            var d = a;
            b && c && (d = t(d * U(b * fa), 4));
            return {x: -a / 3 * $(b * fa), y: d}
        }, label: function (a, b, c, d, e, f, g, h, i) {
            var k = this, j = k.g(i), m = k.text("", 0, 0, g).attr({zIndex: 1}), l, n, r = 0, s = 3, p = 0, v, x, w, t, ba = 0, gb = {}, z, y, Bb, F, E;
            Bb = function () {
                var a, b;
                a = m.element.style;
                ...
                if (y) {
                    ...
                    l.isImg || l.attr(u({width: B(j.width), height: B(j.height)}, gb));
                    gb = null
                }
            };
            F = function () {
    ...
    u(O.prototype, {
        htmlCss: function (a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var i = this.rotation, j = C(this.textWidth), m = k && k.whiteSpace, l = [i, g, b.innerHTML, this.textWidth, this.textAlign].join(",");
                    if (l !== this.cTT) {
            ...
            var d = {}, e = ya ? "-ms-transform" : mb ? "-webkit-transform" : Na ? "MozTransform" : Lb ? "-o-transform" : "";
    ...
    u(Ca.prototype, {
        html: function (a, b, c) {
            var d = this.createElement("span"), e = d.element, f = d.renderer, g = function (a, b) {
    ...
    if (!ca && !ga) {
        J = {
            init: function (a, b) {
                ...
                var f = d ? U(d * fa) : 1, g = d ? $(d * fa) : 0, h = p(this.elemHeight, this.element.offsetHeight), i;
                this.xCorr = f < 0 && -a;
                this.yCorr = g < 0 && -h;
                i = f * g < 0;
            ...
            safeRemoveChild: function (a) {
                ...
                var d = [], e, f = this.element, g = this.renderer, h, i = f.style, k, j = f.path, m, l, n, r;
        ...
        var Cb = {
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    var j, m, l = a.linearGradient || a.radialGradient, n, r, s, p, v, x = "", a = a.stops, w, q = [], ba = function () {
                    ...
                    if (c === "fill")if (i === "gradient")c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, n = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, x = 'angle="' + (90 - W.atan((l - a) / (n - c)) * 180 / ra) + '"', ba(); else {
                        var k = l.r, t = k * 2, u = k * 2, A = l.cx, B = l.cy, z = b.radialReference, y, k = function () {
    ...
    Va.prototype = {
        addLabel: function () {
            ...
            q(d) ? d && d.attr({text: b}) : (this.labelLength = (this.label = d = q(b) && g.enabled ?
            ...
            if (h)h < 0 && c - i *
            k < f ? l = B(c / U(h * fa) - f) : h > 0 && c + i * k > e && (l = B((d - c) / U(h * fa))); else if (d = c + (1 - i) * k, c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i, m = -1), j = F(b.slotWidth, j), j < b.slotWidth && b.labelAlign === "center" && (a.x += m * (b.slotWidth - j - i * (b.slotWidth - F(k, j)))), k > j || b.autoRotation && g.styles.width)l = j;
            if (l) {
                n.width = l;
    ...
    z.PlotLineOrBand.prototype = {
        render: function () {
            var a =
                this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, k = q(i) && q(h), j = d.value, m = d.dashStyle, l = a.svgElem, n = [], r, s = d.color, o = p(d.zIndex, 0), v = d.events, x = {}, w = b.chart.renderer;
            b.isLog && (i = Da(i), h = Da(h), j = Da(j));
            if (g) {
                if (n = b.getPlotLinePath(j, g), x = {stroke: s, "stroke-width": g}, m)x.dashstyle = m
            } else if (k) {
            ...
            } else if (n && n.length && (a.svgElem = l = w.path(n).attr(x).add(), v))for (r in d = function (b) {
                l.on(b, function (c) {
                    v[b].apply(a, [c])
                })
            }, v)d(r);
            ...
            if (!e)e = {align: a.textAlign || a.align, rotation: a.rotation},
    ...
    ka.prototype = {
        ...
        setOptions: function (a) {
            ...
            {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], D(N[this.coll], a))
        },
        defaultLabelFormatter: function () {
            ...
            if (h)g = La(h, this); else if (c)g = b; else if (d)g = Qa(d, b); else if (f && a >= 1E3)for (; f-- && g === A;)c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !==
        ...
        getLinearTickPositions: function (a, b, c) {
            var d, e = ea(S(b / a) * a), f = ea(ua(c / a) * a), g = [];
        ...
        adjustForMinRange: function () {
            ...
            if (this.isXAxis && this.minRange === A && !this.isLog)q(a.min) || q(a.max) ? this.minRange = null : (o(this.series, function (a) {
                i = a.xData;
                for (g = k = a.xIncrement ? 1 : i.length - 1; g > 0; g--)if (h = i[g] - i[g - 1], f === A || h < f)f = h
        ...
        setTickInterval: function (a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, k = d.minPadding, j = d.tickInterval, m = d.tickPixelInterval,
                l = b.categories, n = b.threshold, r = b.softThreshold, s, R, v, x;
        ...
        unsquish: function () {
            var a =
                this.ticks, b = this.options.labels, c = this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), g, h = b.rotation, i = this.chart.renderer.fontMetrics(b.style.fontSize, a[0] && a[0].label), k, j = Number.MAX_VALUE, m, l = function (a) {
                a /= f || 1;
                a = a > 1 ? ua(a) : 1;
                return a * d
            };
        ...
        renderUnsquish: function () {
            ...
            if (this.autoRotation)o(c, function (a) {
                ...
                m.textOverflow = "clip";
                for (n = c.length; !f && n--;)if (r = c[n], i = d[r].label)if (i.styles.textOverflow === "ellipsis" && i.css({textOverflow: "clip"}), i.getBBox().height > this.len / c.length - (h.h - h.f) || d[r].labelLength > g)i.specCss = {textOverflow: "ellipsis"}
            }
            if (k.rotation && (m = {
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f =
                a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, k, j, m = 0, l, n = 0, r = d.title, s = d.labels, R = 0, v = a.opposite, x = b.axisOffset, b = b.clipOffset, w = [-1, 1, 1, -1][h], u, ba = a.axisParent;
            k = a.hasData();
            a.showAxis = j = k || p(d.showEmpty, !0);
            a.staggerLines = a.horiz && s.staggerLines;
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(ba), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(ba), a.labelGroup = c.g("axis-labels").attr({zIndex: s.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(ba);
            if (k || a.isLinked) {
                if (o(e, function (b) {
            ...
            if (r && r.text && r.enabled !== !1) {
                if (!a.axisTitle)a.axisTitle = c.text(r.text, 0, 0, r.useHTML).attr({
                    zIndex: 7, rotation: r.rotation || 0, align: r.textAlign || {
                        low: v ?
                            "right" : "left", middle: "center", high: v ? "left" : "right"
                    }[r.align]
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset,
                i = e.x || 0, k = e.y || 0, j = C(e.style.fontSize || 12), d = {
                    low: f + (a ? 0 : d),
                    middle: f + d / 2,
                    high: f + (a ? d : 0)
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, k = a.minorTicks, j = a.alternateBands, m = d.stackLabels, l = d.alternateGridColor, n = a.tickmarkOffset, r = d.lineWidth, s, p = b.hasRendered &&
                q(a.oldMin) && !isNaN(a.oldMin), v = a.showAxis, x = c.globalAnimation, w, t;
        ...
        drawCrosshair: function (a, b) {
            ...
            if (!this.crosshair ||
                (q(b) || !p(d.snap, !0)) === !1)this.hideCrosshair(); else if (p(d.snap, !0) ? q(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)this.hideCrosshair(); else if (e = this.categories && !this.isRadial, f = p(d.width, e ? this.transA : 1), this.cross)this.cross.attr({
                d: c,
                visibility: "visible",
                "stroke-width": f
            }); else {
                e = {
                    "stroke-width": f, stroke: d.color ||
    ...
    ka.prototype.normalizeTimeTickInterval = function (a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200,
                500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = G[d[0]], f = d[1], g;
    ...
    ka.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (!d)this._minorAutoInterval =
            null;
        if (a >= 0.5)a = B(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = S(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
            i = e.length;
    ...
    Pb.prototype = {
        init: function (a, b) {
            ...
            var d = this.chart, e = this.distance, f = {}, g = c.h || 0, h, i = ["y", d.chartHeight, b, c.plotY + d.plotTop, d.plotTop, d.plotTop + d.plotHeight], k = ["x", d.chartWidth, a, c.plotX + d.plotLeft, d.plotLeft, d.plotLeft + d.plotWidth], j = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), m = function (a,
                                                                                                                                                                                                                                                                                                                                                   b, c, d, h, i) {
            ...
            k === !1 ? this.hide() : (this.isHidden && (Oa(d), d.attr("opacity", 1).show()), d.attr({text: k}), m = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: m}), this.updatePosition({
                plotX: f,
                plotY: g,
                negative: a.negative,
                ttBelow: a.ttBelow,
            ...
            H(c, "tooltipRefresh", {
                text: k, x: f + c.plotLeft, y: g + c.plotTop,
                borderColor: m
            })
            ...
            var c = b ? "footer" : "header", d = a.series, e = d.tooltipOptions, f = e.xDateFormat, g = d.xAxis, h = g && g.options.type === "datetime" && ma(a.key), c = e[c + "Format"];
    ...
    Xa.prototype = {
        init: function (a, b) {
            ...
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared : !1, f = b.hoverPoint, g = b.hoverSeries, h = [Number.MAX_VALUE, Number.MAX_VALUE], i, k, j = [], m = [], l;
            ...
            if (e)for (b = j.length; b--;)(j[b].clientX !== m[1].clientX || j[b].series.noSharedTooltip) && j.splice(b, 1);
            if (m[0] && (m[0] !== this.prevKDPoint || d && d.isHidden))if (e && !m[0].series.noSharedTooltip)j.length && d && d.refresh(j, a), o(j, function (b) {
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, k = b.plotWidth, j = b.plotHeight, m, l = this.selectionMarker, n = this.mouseDownX, r = this.mouseDownY, s = c.panKey && a[c.panKey + "Key"];
            if (!l || !l.touch)if (d < h ? d = h : d > h + k && (d = h + k), e < i ? e = i : e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(r - e, 2)), this.hasDragged > 10) {
                ...
                l && g && (d = e - r, l.attr({height: P(d), y: (d > 0 ? 0 : d) + r}));
            ...
            if (this.selectionMarker) {
                var e = {
                    ...
                    xAxis: [],
                    yAxis: []
                }, f = this.selectionMarker, g = f.attr ? f.attr("x") : f.x, h = f.attr ? f.attr("y") :
                    f.y, i = f.attr ? f.attr("width") : f.width, k = f.attr ? f.attr("height") : f.height, j;
                if (this.hasDragged || d)o(c.axes, function (c) {
                    if (c.zoomEnabled && q(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                        var f = c.horiz, n = a.type === "touchend" ? c.minPixelPadding : 0, r = c.toValue((f ? g : h) + n), f = c.toValue((f ? g + i : h + k) - n);
            ...
            if (c)L(c.container,
                {cursor: c._cursor}), c.cancelClick = this.hasDragged > 10, c.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []
        ...
        onContainerMouseLeave: function (a) {
            ...
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (H(c.series, "click", u(a, {point: c})),
    ...
    u(z.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            (this.zoomVert || this.pinchVert) && this.pinchTranslateDirection(!1, a, b, c, d, e, f)
                                              ...
                                              b, c, d, e, f, g, h) {
            var i = this.chart, k = a ? "x" : "y", j = a ? "X" : "Y", m = "chart" + j, l = a ? "width" : "height", n = i["plot" + (a ? "Left" : "Top")], r, s, p = h || 1, o = i.inverted, x = i.bounds[a ? "h" : "v"], w = b.length === 1, q = b[0][m], t = c[0][m], u = !w && b[1][m], z = !w && c[1][m], B, c = function () {
    ...
    ob.prototype = {
        init: function (a, b) {
            ...
            var c = this.options, d = a.legendItem, e = a.legendLine, f = a.legendSymbol, g = this.itemHiddenStyle.color, c = b ? c.itemStyle.color :
                g, h = b ? a.legendColor || a.color || "#CCC" : g, g = a.options && a.options.marker, i = {fill: h}, k;
            d && d.css({fill: c, color: c});
            e && e.attr({stroke: h});
            if (f) {
                if (g && f.isMarker)for (k in i.stroke = h, g = a.convertAttribs(g), g)d = g[k], d !== A && (i[k] = d);
                f.attr(i)
            }
        ...
        renderTitle: function () {
            ...
            var b =
                this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, k = this.padding, j = e ? p(d.itemDistance, 20) : 0, m = !d.rtl, l = d.width, n = d.itemMarginBottom || 0, r = this.itemMarginTop, s = this.initialItemX, o = a.legendItem, v = a.series && a.series.drawLegendSymbol ? a.series : a, x = v.options, x = this.createCheckboxForItem && x && x.showCheckbox, w = d.useHTML;
            if (!o) {
            ...
            o(this.chart.series, function (b) {
                var c = b.options;
                if (p(c.showInLegend,
                        !q(c.linkedTo) ? A : !1, !0))a = a.concat(b.legendItems || (c.legendType === "point" ? b.data : b))
            });
            return a
            ...
            var a = this, b =
                a.chart, c = b.renderer, d = a.group, e, f, g, h, i = a.box, k = a.options, j = a.padding, m = k.borderWidth, l = k.backgroundColor;
            ...
            f &&
            d.align(u({width: g, height: h}, k), !0, "spacingBox");
            b.isResizing || this.positionCheckboxes()
        }, handleOverflow: function (a) {
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, k = e.navigation, j = p(k.animation, !0), m = k.arrowSize || 12, l = this.nav, n = this.pages, r = this.padding, s, R = this.allItems, v = function (a) {
                i.attr({height: a});
            ...
            if (a > f) {
                ...
                b.scroll(0);
                a = f
            } else if (l)v(c.chartHeight), l.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0;
            return a
        }, scroll: function (a, b) {
    ...
    hb.prototype = {
        callbacks: [], getArgs: function () {
            ...
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, k = this.isDirtyBox, j = c.length, m = j, l = this.renderer, n = l.isHidden(), r = [];
            Ua(a, this);
        ...
        getChartSize: function () {
            ...
            c = ua(t(d, h[0]) / 2);
            this.clipBox = {
                x: b, y: c, width: S(this.plotSizeX - t(d, h[1]) / 2 - b), height: t(0,
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, k = a.backgroundColor, j = a.plotBackgroundColor, m = a.plotBackgroundImage,
                l = a.plotBorderWidth || 0, n, r = this.plotLeft, p = this.plotTop, o = this.plotWidth, v = this.plotHeight, x = this.plotBox, w = this.clipRect, t = this.clipBox;
            n = i + (a.shadow ? 8 : 0);
    ...
    Q.prototype = {
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, k = e.chart, j = null, m = e.xAxis, l = m && !!m.categories, n = i.turboThreshold, r = this.xData, s = this.yData, t = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)o(a, function (a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ma(j)) {
                        ...
                        e.xIncrement = l
                    } else if (Ja(j))if (t)for (c = 0; c < h; c++)j = a[c], r[c] = j[0], s[c] = j.slice(1, t + 1); else for (c = 0; c < h; c++)j = a[c], r[c] = j[0], s[c] = j[1]; else X(12)
                } else for (c = 0; c < h; c++)if (a[c] !== A && (j = {series: e}, e.pointClass.prototype.applyOptions.apply(j, [a[c]]), e.updateParallelArrays(j,
        ...
        processData: function (a) {
            ...
            i = k.cropThreshold;
            var j = this.getExtremesFromAll || k.getExtremesFromAll, m = this.isCartesian,
                k = h && h.val2lin, l = h && h.isLog, n, p;
            if (m && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)return !1;
            if (h)a = h.getExtremes(), n = a.min, p = a.max;
            if (m && this.sorted && !j && (!i || d > i || this.forceCrop))if (b[d - 1] < n || b[0] > p)b = [], c = []; else if (b[0] < n || b[d - 1] > p)e = this.cropData(this.xData, this.yData, n, p), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        generatePoints: function () {
            ...
            if (b && (g !== (c = b.length) || k))for (l = 0; l < c; l++)if (l === h && !k && (l += g), b[l])b[l].destroyElements(), b[l].plotX = A;
            this.data = b;
            this.points = m
        },
        getExtremes: function (a) {
            ...
            for (m = 0; m < d; m++)if (k = c[m], j = a[m], i = j !== null && j !==
                    A && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[m + 1] || k) >= g && (c[m - 1] || k) <= h, i && k)if (i = j.length)for (; i--;)j[i] !== null && (e[f++] = j[i]); else e[f++] = j;
            this.dataMin = Ra(e);
            this.dataMax = Ea(e)
        },
        translate: function () {
        ...
        setClip: function (a) {
            var b =
                this.chart, c = this.options, d = b.renderer, e = b.inverted, f = this.clipBox, g = f || b.clipBox, h = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, g.height, c.xAxis, c.yAxis].join(","), i = b[h], k = b[h + "m"];
            if (!i) {
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, k, j, m = this.options.marker, l = this.pointAttr[""], n, r, o, t = this.markerGroup, v =
                p(m.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * m.radius);
            if (m.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, r = !!g.marker, a = v && n.enabled === A || n.enabled, o = g.isInside, a && e !== A && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j)j[o ? "show" : "hide"](!0).attr(a).animate(u({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            ...
            if (!j || g < j || k)for (; g--;) {
                ...
                if (j.options)for (v in l)q(c[l[v]]) && (k = !0);
                if (k) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
        ...
        getGraphPath: function (a, b, c) {
            var d = this, e = d.options, f = e.step, g = [], h, a = a || d.points;
            o(a, function (i, k) {
                var j = i.plotX, m = i.plotY, l = a[k - 1];
                if ((i.leftCliff || l && l.rightCliff) && !c)h = !0;
                i.isNull && !q(b) && k > 0 ? h = !e.connectNulls : i.isNull && !b ? h = !0 : (k === 0 || h ? l = ["M", i.plotX,
                    i.plotY] : d.getPointSpline ? l = d.getPointSpline(a, i, k) : f ? (l = f === "right" ? ["L", l.plotX, m] : f === "center" ? ["L", (l.plotX + j) / 2, l.plotY, "L", (l.plotX + j) / 2, m] : ["L", j, l.plotY], l.push("L", j, m)) : l = ["L", j, m], g.push.apply(g, l), h = !1)
            });
        ...
        applyZones: function () {
            ...
            "y") + "Axis"], l, n = m.reversed, r = b.inverted, s = m.horiz, q, v, x, w = !1;
            if (d.length && (i || k) && m.min !== A)i && i.hide(), k && k.hide(), l = m.getExtremes(), o(d, function (d, o) {
                ...
                b.inverted && c.isVML && (h = m.isXAxis ? {
                    x: 0, y: n ?
                        v : x, height: h.width, width: b.chartWidth
    ...
    Q.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.startFromThreshold ?
                f : 0, h = e.stack, e = e.stacking, i = this.stackKey, k = "-" + i, j = this.negStacks, m = this.yAxis, l = m.stacks, n = m.oldStacks, o, s, q, v, x, w, u;
            m.stacksTouched += 1;
            for (x = 0; x < d; x++) {
                w = a[x];
                u = b[x];
    ...
    Q.prototype.setPercentStacks = function () {
        ...
        o([b, "-" + b], function (b) {
            var f;
            for (var g = d.length, h, i; g--;)if (h = d[g],
    ...
    u(Ia.prototype, {
        update: function (a, b, c, d) {
            ...
            d === !1 ? e() : f.firePointEvent("update", {options: a},
                e)
        }, remove: function (a, b) {
    ...
    u(Q.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this, f = e.options, g = e.data, h = e.graph, i = e.area, k = e.chart, j = e.xAxis && e.xAxis.names, m = h && h.shift || 0, l = ["graph", "area"], h = f.data, n, r = e.xData;
            Ua(d, k);
            if (c) {
            ...
            var c = this, d = this.chart, e = this.userOptions, f = this.type, g = I[f].prototype, h = ["group", "markerGroup", "dataLabelsGroup"],
                i;
    ...
    var la = pa(Q, {
        type: "area", singleStacks: !1, getStackPoints: function () {
            var a = [], b = [], c = this.xAxis, d = this.yAxis, e = d.stacks[this.stackKey], f = {}, g = this.points, h = this.index, i = d.series, k = i.length, j, m = p(d.options.reversedStacks, !0) ? 1 : -1, l, n;
            if (this.options.stacking) {
                ...
                o(b, function (g, i) {
                    ...
                    if (f[g] && !f[g].isNull)a.push(f[g]), o([-1, 1], function (a) {
                        var c =
                            a === 1 ? "rightNull" : "leftNull", d = 0, n = e[b[i + a]];
                        if (n)for (l = h; l >= 0 && l < k;)p = n.points[l], p || (l === h ? f[g][c] = !0 : j[l] && (q = e[g].points[l]) && (d -= q[1] - q[0])), l += m;
            ...
            var b = Q.prototype.getGraphPath, c = this.options, d = c.stacking, e = this.yAxis, f, g, h = [], i = [], k = this.index, j, m = e.stacks[this.stackKey],
                l = c.threshold, n = e.getThreshold(c.threshold), o, c = c.connectNulls || d === "percent", s = function (b, c, f) {
                    var g = a[b], b = d && m[g.x].points[k], p = g[f + "Null"] || 0, f = g[f + "Cliff"] || 0, o, r, g = !0;
            ...
            for (f = 0; f < a.length; f++)if (g = a[f].isNull, j = p(a[f].rectPlotX, a[f].plotX), o = p(a[f].yBottom,
                    n), !g || c) {
                c || s(f, f - 1, "left");
    ...
    wa = pa(Q, {
        ...
        directTouch: !0, trackerGroups: ["group", "dataLabelsGroup"], negStacks: !0, init: function () {
            ...
            var i = F(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), k = i * b.groupPadding, j = (i - 2 * k) / h, b = F(b.maxPointWidth || c.len, p(b.pointWidth, j * (1 - 2 * b.pointPadding)));
            a.columnMetrics = {
                width: b,
            ...
            o(a.points, function (c) {
                var d = F(p(c.yBottom, f), 9E4), h = 999 + P(d), h = F(t(-h, c.plotY), e.len + h), o = c.plotX + j, s = k, q = F(h, d), v, u = t(h, d) - q;
    ...
    da = {
        ...
        translate: function (a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, k = this.startAngleRad = ra / 180 * (i - 90), i = (this.endAngleRad = ra / 180 * (p(c.endAngle, i + 360) - 90)) - k, j =
                this.points, m = c.dataLabels.distance, c = c.ignoreHiddenPoint, l, n = j.length, o;
            ...
            for (l = 0; l < n; l++) {
                ...
                o.slicedTranslation = {translateX: B(U(h) * d), translateY: B($(h) * d)};
                f =
                    U(h) * a[2] / 2;
                g = $(h) * a[2] / 2;
    ...
    Q.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (k.attr({opacity: +h}), h || M(a, "afterAnimate", function () {
            a.visible && k.show();
            k[b.animation ?
    ...
    Q.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart,
            g = f.inverted, h = p(a.plotX, -9999), i = p(a.plotY, -9999), k = b.getBBox(), j = f.renderer.fontMetrics(c.style.fontSize).b, m = c.rotation, l = c.align, n = this.visible && (a.series.forceDL || f.isInsidePlot(h, B(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)), o = p(c.overflow, "justify") === "justify";
        if (n)d = u({
            x: g ? f.plotWidth - i : h,
    ...
    Q.prototype.justifyDataLabel = function (a, b, c, d, e, f) {
        var g = this.chart, h = b.align, i = b.verticalAlign, k,
    ...
    if (I.pie)I.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth,
            1), h = d.plotWidth, i = d.plotHeight, k, j, m = p(e.softConnector, !0), l = e.distance, n = a.center, r = n[2] / 2, q = n[1], u = l > 0, v, x, w, z = [[], []], A, y, E, D, C, G = [0, 0, 0, 0], L = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (D = 2; D--;) {
                ...
                if (K) {
                    ...
                    for (C = 0; C < K; C++) {
                        ...
                        v._pos = {x: A + e.x + ({left: f, right: -f}[w[6]] || 0), y: y + e.y - 10};
                        v.connX = A;
                        v.connY = y;
            ...
            u && g && o(this.points, function (b) {
                k = b.connector;
                w = b.labelPos;
                if ((v = b.dataLabel) && v._pos && b.visible)E = v._attr.visibility, A = v.connX, y = v.connY, j = m ? ["M", A + (w[6] === "left" ? 5 : -5), y, "C", A, y, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", A + (w[6] === "left" ? 5 : -5), y, "L", w[2], w[3], "L", w[4], w[5]], k ? (k.animate({d: j}), k.attr("visibility", E)) : b.connector = k = a.chart.renderer.path(j).attr({
                    "stroke-width": g,
    ...
    (function (a) {
        ...
        b.prototype.hideOverlappingLabels = function (a) {
            var b = a.length, d, e, k, j, m, l, n, o, p;
            ...
            for (e = 0; e < b; e++) {
                k =
                    a[e];
                for (d = e + 1; d < b; ++d)if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (m = k.alignAttr, l = j.alignAttr, n = k.parentGroup, o = j.parentGroup, p = 2 * (k.box ? 0 : k.padding), m = !(l.x + o.translateX > m.x + n.translateX + (k.width - p) || l.x + o.translateX + (j.width - p) < m.x + n.translateX || l.y + o.translateY > m.y + n.translateY + (k.height - p) || l.y + o.translateY + (j.height - p) < m.y + n.translateY)))(k.labelrank < j.labelrank ? k : j).newOpacity = 0
            }
            c(a, function (a) {
                var b, c;
                if (a) {
    ...
    da = z.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, k = a.tracker, j = b.cursor, m = j && {cursor: j}, l = function () {
                if (f.hoverSeries !== a)a.onMouseOver()
            }, n = "rgba(192,192,192," + (ca ? 1.0E-4 : 0.002) + ")";
            if (e && !c)for (j = e + 1; j--;)d[j] ===
    ...
    u(hb.prototype, {
        showResetZoom: function () {
            var a = this, b = N.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states, f = c.relativeTo === "chart" ?
                null : "plotBox";
            ...
            o(b === "xy" ? [1, 0] : [1], function (b) {
                var b = c[b ? "xAxis" : "yAxis"][0], d = b.horiz, h = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", i = c[d], k = (b.pointRange || 0) / 2, j = b.getExtremes(), m = b.toValue(i - h,
                        !0) + k, k = b.toValue(i + b.len - h, !0) - k, i = i > h;
                if (b.series.length && (i || m > F(j.dataMin, j.min)) && (!i || k < t(j.dataMax, j.max)))b.setExtremes(m, k, !1, !1, {trigger: "pan"}), e = !0;
                c[d] = h
            });
            e && c.redraw(!1);
    ...
    u(Ia.prototype, {
        select: function (a, b) {
            ...
            var c = S(this.plotX), d = this.plotY, e = this.series, f = e.options.states, g = aa[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], k = i && i.enabled === !1, j = e.stateMarkerGraphic, m = this.marker || {}, l = e.chart, n = e.halo, o, a = a || "";
            o = this.pointAttr[a] ||
                e.pointAttr[a];
