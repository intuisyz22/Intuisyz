...
// if(!isset($_SESSION))
//     header("location:".BASE_URL."user/candidate.php");
...
<div class="modal inmodal" id="instructionsModal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-body" id="modal_instruction">
                </div>
    ...
    <script src="mock_instruction.js"></script>
